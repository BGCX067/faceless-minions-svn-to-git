    ...
    hero_(NULL)
{
    ...
    portrait_.setTexture(*resource_handler::get()->get_texture("images/interface/portrait_dummy.png"));
...
void skillbar::set_selected_hero(character_hero* hero)
{
    ...
    for (int i = 0; i < 5; ++i)
    {
        ...
        buttons_[i]->set_data(resource_handler::get()->get_root_node("skills")->child(hero->get_skill(i).get_name())->child("tooltip"));
