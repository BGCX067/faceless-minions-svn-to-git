    ...
    gold_interp_(false)
{
    ...
    party_gold_.setColor(utils::rgb(0x190701));
    party_gold_.setFont(*resource_handler::get()->get_font("text"));
...
void menu_bar::reset_position()
{
    ...
    party_gold_.setPosition(origin + (math::vector2f(state_manager::get()->get_dimensions().x - party_gold_.getLocalBounds().width - 40.0f, 0.0f)));
