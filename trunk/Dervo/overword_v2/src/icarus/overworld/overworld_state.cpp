...
bool overworld_state::setup_overworld()
{
    ...
    //grid_creator_.generate_nature_tiles(hex_grid_, nature_tiles_,0,4,0.16,2,true);
    //grid_creator_.variate_background_tiles(hex_grid_);
    grid_creator_.generate_captial_cities(nation_tiles_[RED_], 2, 0);
    grid_creator_.generate_captial_cities(nation_tiles_[BLUE_], 4, 1);
    grid_creator_.generate_captial_cities(nation_tiles_[GREEN_], 5, 2);
    grid_creator_.generate_captial_cities(nation_tiles_[SPAWN_], 9, 3);
