...
bool state::setup_encounter(const encounter_data& new_encounter)
{
    ...
    player_list.back()->load_sprite("images/characters/test2.png",
    ...
    player_list.back()->load_sprite("images/characters/test2.png",
                                    sf::IntRect(sf::Vector2i(0, 0),
                                                sf::Vector2i(63, 140)),
                                    math::vector2f(30.0f, 130.0f));
    player_list.back()->tp_to_tile(math::vector2u(6, 0), grid_);
    player_list.back()->set_debug(true);
    player_list.push_back(new character());
    player_list.back()->load_sprite("images/characters/test2.png",
                                    sf::IntRect(sf::Vector2i(0, 0),
                                                sf::Vector2i(63, 140)),
                                    math::vector2f(30.0f, 130.0f));
    player_list.back()->tp_to_tile(math::vector2u(6, 1), grid_);
    player_list.back()->set_debug(true);
    player_list.push_back(new character());
    player_list.back()->load_sprite("images/characters/test2.png",
                                    sf::IntRect(sf::Vector2i(0, 0),
                                                sf::Vector2i(63, 140)),
                                    math::vector2f(30.0f, 130.0f));
    player_list.back()->tp_to_tile(math::vector2u(6, 2), grid_);
    player_list.back()->set_debug(true);
    player_list.push_back(new character());
    player_list.back()->load_sprite("images/characters/test2.png",
                                    sf::IntRect(sf::Vector2i(0, 0),
                                                sf::Vector2i(63, 140)),
                                    math::vector2f(30.0f, 130.0f));
    player_list.back()->tp_to_tile(math::vector2u(6, 4), grid_);
    player_list.back()->set_debug(true);
    player_list.push_back(new character());
    player_list.back()->load_sprite("images/characters/test2.png",
                                    sf::IntRect(sf::Vector2i(0, 0),
                                                sf::Vector2i(63, 140)),
                                    math::vector2f(30.0f, 130.0f));
    player_list.back()->tp_to_tile(math::vector2u(6, 5), grid_);
    player_list.back()->set_debug(true);
    return true;
}
