        ...
        case sf::Event::MouseButtonReleased:
            {
                ...
                {
                    if (party_[k].contains(mouse_pos) && !party_[k].delete_contains(mouse_pos))
                    {
                    ...
                    else if (party_[k].delete_contains(mouse_pos) && !drag_party_member_)
                    {
                        if (gui_handler::get()->party_screen_visible() &&
                            gui_handler::get()->party_screen_index() == int(k))
                        {
                            gui_handler::get()->close_party_screen();
                        }
                        party_handler::get()->remove_member(k);
                        setup_dialog();
                    }
                }
