...
namespace ui
{
bar::bar(const sf::Color& bar_color,
    ...
    bar_height_(15.0f)
{
    ...
    label_->setCharacterSize(static_cast<int>(14));
    label_->setColor(utils::rgb(0xffdd4e));
...
void bar::set_size(const math::vector2f& new_size)
{
...
void bar::set_label(const std::string& new_label)
{
    label_->setString(new_label);
    update_label_origin();
}

void bar::update_label_origin()
{
...
void bar::set_bar_fill(float percentage)
{
...
void bar::set_label_position(label_position::vertical v_pos,
...
void bar::set_position(const math::vector2f& new_pos)
{
...
math::vector2f bar::get_position()
{
