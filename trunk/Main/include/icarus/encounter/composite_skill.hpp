...
public:
    ...
    bool is_ultimate() const { return is_ultimate_; }
    int get_ammo_cost() const { return ammunition_cost_; }
    bool requires_los() const { return requires_los_; }
    bool is_teleport() const { return is_teleport_; }
    bool is_available() const
    {
        return (is_leveled_ ? (level_ > 0 && is_ready()) : is_ready());
    }
};
}   // namespace encounter
}   // namespace icarus
