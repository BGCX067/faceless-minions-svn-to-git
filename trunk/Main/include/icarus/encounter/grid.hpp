...
public:
    ...
    grid_tile* get_tile_at(unsigned row, unsigned col, bool untranslated = false) const;
    grid_tile* get_tile_at(const math::vector2i& vec_pos, bool untranslated = false) const;
    ...
    bool get_path_to_tile(const math::vector2i& target_tile,
    ...
    void get_intersections(const math::vector2f& a1,
