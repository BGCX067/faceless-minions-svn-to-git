#ifndef ICARUS_UI_BASE_TOOLTIP_HPP_
#define ICARUS_UI_BASE_TOOLTIP_HPP_
...
public:
    ...
    void set_tt_type(tooltip_type::value type) { tooltip_type_ = type; }
...
#endif // ICARUS_UI_BASE_TOOLTIP_HPP_
